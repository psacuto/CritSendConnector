...
namespace Com.CritSend.Connector
{
    ...
    public class CritSendConnect
    {
        ...
        private string GetRandomHost(IList<string> hosts)
        {
            ...
            string host = WithWsdl(hosts[index]);
            return host;
        }
        ...
        private WSDL01forMxMaster CreateClient(string host)
        {
            ...
            try
            {
                client = new WSDL01forMxMaster { EnableDecompression = true, Url = WithWsdl(host) };
        ...
        private string WithWsdl(string host)
        {
            return host.EndsWith(Wsdl) ? host : host + Wsdl;
        }
